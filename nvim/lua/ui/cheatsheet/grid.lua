...
require('ui.utils').highlight {
	-- Heading Highlight
	NvChHeading = { fg = b16.black, bg = b16.blue },

	-- Section Background
	NvChSection = { bg = b16.black2 },

	-- ASCII Header Highlight
	NvChAsciiHeader = { fg = b16.blue, bg = b16.black2 },

	-- Dynamic Heading Colors
	NvChHeadblue = { fg = b16.black, bg = b16.blue },
	NvChHeadred = { fg = b16.black, bg = b16.red },
	NvChHeadgreen = { fg = b16.black, bg = b16.green },
	NvChHeadyellow = { fg = b16.black, bg = b16.yellow },
	NvChHeadbrightyellow = { fg = b16.black, bg = b16.brightyellow },
	NvChHeadmagenta = { fg = b16.black, bg = b16.magenta },
	NvChHeadbrightmagenta = { fg = b16.black, bg = b16.brightmagenta },
	NvChHeadwhite = { fg = b16.black, bg = b16.white },
	NvChHeadcyan = { fg = b16.black, bg = b16.cyan },
	NvChHeadbrightgreen = { fg = b16.black, bg = b16.brightgreen },
}

local api = vim.api
local ch = require 'ui.cheatsheet'
...
return function(buf, win, action)
	...
	if action == 'open' then state.mappings_tb = ch.organize_mappings() end
