...
echo -e "${CYAN}󰓒 [$((++step))/14] INSTALLING COMMANDS & APPS 󰓒${RESET}"
...
echo -e "${CYAN}󰓒 [$((++step))/14] SET ENVIRONMENT 󰓒${RESET}"
...
echo -e "${CYAN}󰓒 [$((++step))/14] CREATE SYMLINKS & DIRECTORIES 󰓒${RESET}"
...
echo -e "${CYAN}󰓒 [$((++step))/14] CONFIGURE MACOS OPTIONS 󰓒${RESET}"
...
echo -e "${CYAN}󰓒 [$((++step))/14] CONFIGURE GIT AND GITHUB CLI 󰓒${RESET}"
...
echo -e "${CYAN}󰓒 [$((++step))/14] INSTALL TEMPLATES 󰓒${RESET}"
gh repo clone vivek-x-jha/templates "$XDG_DATA_HOME/templates" # TODO need to test this

echo -e "${CYAN}󰓒 [$((++step))/14] INSTALL SHELL PLUGINS 󰓒${RESET}"
...
echo -e "${CYAN}󰓒 [$((++step))/14] SETUP ATUIN SYNC 󰓒${RESET}"
...
echo -e "${CYAN}󰓒 [$((++step))/14] LOAD BAT THEMES 󰓒${RESET}"

# Rebuild bat cache any time theme folder changes
bat cache --build

echo -e "${CYAN}󰓒 [$((++step))/14] SETUP TOUCHID SUDO 󰓒${RESET}"
...
echo -e "${CYAN}󰓒 [$((++step))/14] SURPRESS ITERM2 LOGIN 󰓒${RESET}"
echo 'CREATED ~/.hushlogin'
touch "$HOME/.hushlogin"

echo -e "${CYAN}󰓒 [$((++step))/14] CHANGE SHELL 󰓒${RESET}"
