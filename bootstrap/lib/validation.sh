...
check_bootstrap() {
  ...
  check_path "$BOOTSTRAP_ROOT/ai/pi/extensions/web-search.ts"
...
doctor_bootstrap() {
  ...
  doctor_symlink "$XDG_STATE_HOME/pi/agent/extensions/web-search.ts" ../../../../../.dotfiles/ai/pi/extensions/web-search.ts
