...
'*-v[Increase verbosity (-v for DEBUG, -vv for TRACE, -vvv for global TRACE)]' \
'*--verbose[Increase verbosity (-v for DEBUG, -vv for TRACE, -vvv for global TRACE)]' \
'-h[Print help]' \
'--help[Print help]' \
'-V[Print version]' \
...
(( $+functions[_bob__subcmd__complete_commands] )) ||
_bob__subcmd__complete_commands() {
    local commands; commands=()
    _describe -t commands 'bob complete commands' commands "$@"
}
(( $+functions[_bob__subcmd__erase_commands] )) ||
_bob__subcmd__erase_commands() {
    local commands; commands=()
    _describe -t commands 'bob erase commands' commands "$@"
}
(( $+functions[_bob__subcmd__help_commands] )) ||
_bob__subcmd__help_commands() {
    local commands; commands=(
'use:Switch to the specified version, by default will auto-invoke install command if the version is not installed already' \
'install:Install the specified version, can also be used to update out-of-date nightly version' \
...
(( $+functions[_bob__subcmd__help__subcmd__complete_commands] )) ||
_bob__subcmd__help__subcmd__complete_commands() {
    local commands; commands=()
    _describe -t commands 'bob help complete commands' commands "$@"
}
(( $+functions[_bob__subcmd__help__subcmd__erase_commands] )) ||
_bob__subcmd__help__subcmd__erase_commands() {
    local commands; commands=()
    _describe -t commands 'bob help erase commands' commands "$@"
}
(( $+functions[_bob__subcmd__help__subcmd__help_commands] )) ||
_bob__subcmd__help__subcmd__help_commands() {
    local commands; commands=()
    _describe -t commands 'bob help help commands' commands "$@"
}
(( $+functions[_bob__subcmd__help__subcmd__install_commands] )) ||
_bob__subcmd__help__subcmd__install_commands() {
    local commands; commands=()
    _describe -t commands 'bob help install commands' commands "$@"
}
(( $+functions[_bob__subcmd__help__subcmd__list_commands] )) ||
_bob__subcmd__help__subcmd__list_commands() {
    local commands; commands=()
    _describe -t commands 'bob help list commands' commands "$@"
}
(( $+functions[_bob__subcmd__help__subcmd__list-remote_commands] )) ||
_bob__subcmd__help__subcmd__list-remote_commands() {
    local commands; commands=()
    _describe -t commands 'bob help list-remote commands' commands "$@"
}
(( $+functions[_bob__subcmd__help__subcmd__rollback_commands] )) ||
_bob__subcmd__help__subcmd__rollback_commands() {
    local commands; commands=()
    _describe -t commands 'bob help rollback commands' commands "$@"
}
(( $+functions[_bob__subcmd__help__subcmd__run_commands] )) ||
_bob__subcmd__help__subcmd__run_commands() {
    local commands; commands=()
    _describe -t commands 'bob help run commands' commands "$@"
}
(( $+functions[_bob__subcmd__help__subcmd__sync_commands] )) ||
_bob__subcmd__help__subcmd__sync_commands() {
    local commands; commands=()
    _describe -t commands 'bob help sync commands' commands "$@"
}
(( $+functions[_bob__subcmd__help__subcmd__uninstall_commands] )) ||
_bob__subcmd__help__subcmd__uninstall_commands() {
    local commands; commands=()
    _describe -t commands 'bob help uninstall commands' commands "$@"
}
(( $+functions[_bob__subcmd__help__subcmd__update_commands] )) ||
_bob__subcmd__help__subcmd__update_commands() {
    local commands; commands=()
    _describe -t commands 'bob help update commands' commands "$@"
}
(( $+functions[_bob__subcmd__help__subcmd__use_commands] )) ||
_bob__subcmd__help__subcmd__use_commands() {
    local commands; commands=()
    _describe -t commands 'bob help use commands' commands "$@"
}
(( $+functions[_bob__subcmd__install_commands] )) ||
_bob__subcmd__install_commands() {
    local commands; commands=()
    _describe -t commands 'bob install commands' commands "$@"
}
(( $+functions[_bob__subcmd__list_commands] )) ||
_bob__subcmd__list_commands() {
    local commands; commands=()
    _describe -t commands 'bob list commands' commands "$@"
}
(( $+functions[_bob__subcmd__list-remote_commands] )) ||
_bob__subcmd__list-remote_commands() {
    local commands; commands=()
    _describe -t commands 'bob list-remote commands' commands "$@"
}
(( $+functions[_bob__subcmd__rollback_commands] )) ||
_bob__subcmd__rollback_commands() {
    local commands; commands=()
    _describe -t commands 'bob rollback commands' commands "$@"
}
(( $+functions[_bob__subcmd__run_commands] )) ||
_bob__subcmd__run_commands() {
    local commands; commands=()
    _describe -t commands 'bob run commands' commands "$@"
}
(( $+functions[_bob__subcmd__sync_commands] )) ||
_bob__subcmd__sync_commands() {
    local commands; commands=()
    _describe -t commands 'bob sync commands' commands "$@"
}
(( $+functions[_bob__subcmd__uninstall_commands] )) ||
_bob__subcmd__uninstall_commands() {
    local commands; commands=()
    _describe -t commands 'bob uninstall commands' commands "$@"
}
(( $+functions[_bob__subcmd__update_commands] )) ||
_bob__subcmd__update_commands() {
    local commands; commands=()
    _describe -t commands 'bob update commands' commands "$@"
}
(( $+functions[_bob__subcmd__use_commands] )) ||
_bob__subcmd__use_commands() {
    local commands; commands=()
