...
local highlights = {
  ...
  gitconfigVariable = { fg = thm.white },
  ...
  ['@markup.heading.4.markdown'] = { fg = thm.brightwhite, bold = true },
  ['@markup.heading.5.markdown'] = { fg = thm.black, bold = true },
  ['@markup.heading.6.markdown'] = { fg = thm.brightblack, bold = true },
  ['@markup.link.label.markdown_inline'] = { fg = thm.yellow },
  ['@markup.link.url.markdown_inline'] = { fg = thm.brightblack, underline = true },
  ['@markup.quote.markdown'] = { fg = thm.brightblack },

  -------------------------- Render Markdown -----------------------------
  RenderMarkdownH1 = { fg = thm.cyan, bold = true },
  RenderMarkdownH2 = { fg = thm.magenta, bold = true },
  RenderMarkdownH3 = { fg = thm.blue, bold = true },
  RenderMarkdownH4 = { fg = thm.brightwhite, bold = true },
  RenderMarkdownH5 = { fg = thm.black, bold = true },
  RenderMarkdownH6 = { fg = thm.brightblack, bold = true },
  RenderMarkdownH1Bg = { fg = thm.cyan, bg = thm.nvim_bg, bold = true },
  RenderMarkdownH2Bg = { fg = thm.magenta, bg = thm.nvim_bg, bold = true },
  RenderMarkdownH3Bg = { fg = thm.blue, bg = thm.nvim_bg, bold = true },
  RenderMarkdownH4Bg = { fg = thm.brightwhite, bg = thm.nvim_bg, bold = true },
  RenderMarkdownH5Bg = { fg = thm.black, bg = thm.nvim_bg, bold = true },
  RenderMarkdownH6Bg = { fg = thm.brightblack, bg = thm.nvim_bg, bold = true },
  RenderMarkdownCode = { fg = thm.white, bg = thm.grey },
  RenderMarkdownCodeInfo = { fg = thm.brightyellow, bg = thm.grey },
  RenderMarkdownCodeBorder = { fg = thm.brightblack, bg = thm.grey },
  RenderMarkdownCodeInline = { fg = thm.brightred, bg = thm.grey },
  RenderMarkdownQuote = { fg = thm.brightblack },
  RenderMarkdownDash = { fg = thm.brightblack },
  RenderMarkdownBullet = { fg = thm.white },
  RenderMarkdownLink = { fg = thm.brightblack },
  RenderMarkdownUnchecked = { fg = thm.brightblack },
  RenderMarkdownChecked = { fg = thm.green },
  RenderMarkdownTableHead = { fg = thm.cyan, bold = true },
  RenderMarkdownTableRow = { fg = thm.white },
  ...
  gitconfigSection = { fg = thm.magenta },
  gitconfigAssignment = { fg = thm.green },
  gitconfigNone = { fg = thm.black },
  ...
  --------------------------- TypeScript / TSX ---------------------------
  typescriptNumber = { fg = thm.brightyellow },
  typescriptBoolean = { fg = thm.magenta },
  typescriptNull = { fg = thm.magenta },
  typescriptString = { fg = thm.green },
  typescriptTemplate = { fg = thm.green },
  typescriptRegexpString = { fg = thm.green },
  typescriptComment = { fg = thm.brightblack, italic = true },
  typescriptLineComment = { fg = thm.brightblack, italic = true },
  typescriptDocComment = { fg = thm.brightblack, italic = true },

  typescriptVariableDeclaration = { fg = thm.yellow },
  typescriptDestructureVariable = { fg = thm.yellow },
  typescriptDestructureLabel = { fg = thm.white },
  typescriptArrowFuncArg = { fg = thm.white },
  typescriptFuncCallArg = { fg = thm.white },
  typescriptObjectLabel = { fg = thm.white },
  typescriptMember = { fg = thm.white },
  typescriptProp = { fg = thm.white },

  typescriptFuncName = { fg = thm.blue },
  typescriptCallable = { fg = thm.blue },
  typescriptClassName = { fg = thm.blue },
  typescriptInterfaceName = { fg = thm.blue },
  typescriptGlobal = { fg = thm.blue },
  typescriptPredefinedType = { fg = thm.blue },
  typescriptTypeReference = { fg = thm.blue },

  typescriptIdentifierName = { fg = thm.white },
  typescriptBOMWindowProp = { fg = thm.white },
  typescriptVariable = { fg = thm.magenta },
  typescriptImport = { fg = thm.magenta },
  typescriptExport = { fg = thm.magenta },
  typescriptAliasKeyword = { fg = thm.magenta },
  typescriptFuncKeyword = { fg = thm.magenta },
  typescriptClassKeyword = { fg = thm.magenta },
  typescriptInterfaceKeyword = { fg = thm.magenta },
  typescriptCastKeyword = { fg = thm.magenta },
  typescriptStatementKeyword = { fg = thm.magenta },
  typescriptConditional = { fg = thm.magenta },
  typescriptConditionalElse = { fg = thm.magenta },
  typescriptRepeat = { fg = thm.magenta },
  typescriptBranch = { fg = thm.magenta },
  typescriptCase = { fg = thm.magenta },
  typescriptDefault = { fg = thm.magenta },
  typescriptAsyncFuncKeyword = { fg = thm.magenta },
  typescriptArrowFunc = { fg = thm.magenta },

  typescriptAssign = { fg = thm.white },
  typescriptBinaryOp = { fg = thm.white },
  typescriptKeywordOp = { fg = thm.white },
  typescriptOperator = { fg = thm.white },
  typescriptTernaryOp = { fg = thm.white },
  typescriptDotNotation = { fg = thm.white },
  typescriptEndColons = { fg = thm.white },
  typescriptBraces = { fg = thm.white },
  typescriptParens = { fg = thm.white },
  typescriptTypeBrackets = { fg = thm.white },
  typescriptFuncComma = { fg = thm.white },

  tsxTagName = { fg = thm.magenta },
  tsxIntrinsicTagName = { fg = thm.magenta },
  tsxAttrib = { fg = thm.brightmagenta },
  tsxString = { fg = thm.green },
  tsxEqual = { fg = thm.white },
  tsxTag = { fg = thm.brightred },
  tsxCloseTag = { fg = thm.brightred },
  tsxCloseString = { fg = thm.brightred },
  tsxEntity = { fg = thm.cyan },
  tsxEntityPunct = { fg = thm.white },

  ------------------------------ Shell -----------------------------------
  bashStatement = { fg = thm.magenta },
  shCommandName = { fg = thm.blue },
  shControlKeyword = { fg = thm.magenta },
  shStatement = { fg = thm.magenta },
  shConditional = { fg = thm.magenta },
  shDoubleQuote = { fg = thm.green },
  shOption = { fg = thm.white },
  shPathLike = { fg = thm.white },
  shRepeat = { fg = thm.yellow },
  shOperator = { fg = thm.black },
  shQuote = { fg = thm.black },
  shSingleQuote = { fg = thm.green },
  shSource = { fg = thm.magenta },
  shAlias = { fg = thm.red },
  shSet = { fg = thm.magenta },
  shSetList = { fg = thm.white },
  shFunctionOne = { fg = thm.magenta },
  ...
  shDeref = { fg = thm.red },
  shDerefSimple = { fg = thm.red },
  shShellVariables = { fg = thm.red },
  zshCommandName = { fg = thm.blue },
  zshCommands = { fg = thm.blue },
  zshConfigBuiltin = { fg = thm.magenta },
  zshConditional = { fg = thm.magenta },
  zshControlKeyword = { fg = thm.magenta },
  zshFunction = { fg = thm.magenta },
  zshPathLike = { fg = thm.white },
  zshString = { fg = thm.green },
  zshStringDelimiter = { fg = thm.black },
  zshDeref = { fg = thm.red },
  zshPrecommand = { fg = thm.magenta },
  zshSubst = { fg = thm.red },
  zshSubstDelim = { fg = thm.black },
  zshSubstQuoted = { fg = thm.yellow },
  zshOperator = { fg = thm.black },
  zshRedir = { fg = thm.white },
  zshComment = { fg = thm.brightblack, italic = true },
  zshVariable = { fg = thm.white },
  ...
  BlinkCmpSignatureHelp = { fg = thm.white },
  ...
  NvimTreeExecFile = { link = 'NvimTreeFileName' },
  NvimTreeSpecialFile = { fg = thm.brightblack },
  ...
  ---------------------------- UI / StatusLine ----------------------------
  StatusLine = { fg = thm.yellow, bg = thm.nvim_statusline },
  StatusLineNC = { fg = thm.yellow, bg = thm.nvim_statusline },

  StText = { fg = thm.brightgreen, bg = thm.nvim_statusline },

  St_file = { fg = thm.white, bg = thm.nvim_statusline },
  St_filemodIcon = { fg = thm.brightred, bg = thm.nvim_statusline },
  St_filemod = { fg = thm.brightred, bg = thm.nvim_statusline, underline = true },
  St_cursor = { fg = thm.black, bg = thm.nvim_statusline },
  St_cwd = { fg = thm.blue, bg = thm.nvim_statusline },
  St_ft = { fg = thm.brightblue, bg = thm.nvim_statusline },

  St_lspMsg = { fg = thm.brightyellow, bg = thm.nvim_statusline },
  St_lspError = { fg = thm.brightred, bg = thm.nvim_statusline },
  St_lspWarning = { fg = thm.brightyellow, bg = thm.nvim_statusline },
  St_lspHints = { fg = thm.brightmagenta, bg = thm.nvim_statusline },
  St_lspInfo = { fg = thm.brightblue, bg = thm.nvim_statusline },
  St_lsp = { fg = thm.cyan, bg = thm.nvim_statusline },

  St_GitAdded = { fg = thm.green, bg = thm.nvim_statusline },
  St_GitChanged = { fg = thm.yellow, bg = thm.nvim_statusline },
  St_GitRemoved = { fg = thm.red, bg = thm.nvim_statusline },
  St_GitAhead = { fg = thm.brightblue, bg = thm.nvim_statusline },
  St_GitBehind = { fg = thm.brightblue, bg = thm.nvim_statusline },
  St_GitUntracked = { fg = thm.red, bg = thm.nvim_statusline },
  St_GitBranch = { fg = thm.magenta, bg = thm.nvim_statusline },
  St_GitConflicted = { fg = thm.brightred, bg = thm.nvim_statusline },

  St_NormalMode = { fg = thm.brightblue, bg = thm.nvim_statusline },
  St_VisualMode = { fg = thm.brightcyan, bg = thm.nvim_statusline },
  St_InsertMode = { fg = thm.brightred, bg = thm.nvim_statusline },
  St_TerminalMode = { fg = thm.brightgreen, bg = thm.nvim_statusline },
  St_NTerminalMode = { fg = thm.yellow, bg = thm.nvim_statusline },
  St_ReplaceMode = { fg = thm.brightyellow, bg = thm.nvim_statusline },
  St_ConfirmMode = { fg = thm.cyan, bg = thm.nvim_statusline },
  St_CommandMode = { fg = thm.brightgreen, bg = thm.nvim_statusline },
  St_SelectMode = { fg = thm.blue, bg = thm.nvim_statusline },
