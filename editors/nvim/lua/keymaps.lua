...
vim.keymap.set(
  'n',
  '<leader>un',
  function() require('plugins.fzf.pickers.notifications').history() end,
  { desc = 'Notifications: history (fzf-lua)' }
)
...
vim.keymap.set('n', '<leader>h', function() require('ui.terminal').open { pos = 'sp' } end, { desc = 'Open [h]orizontal terminal' })
vim.keymap.set('n', '<leader>v', function() require('ui.terminal').open { pos = 'vsp' } end, { desc = 'Open [v]ertical terminal' })
vim.keymap.set(
  { 'n', 't' },
  '<A-v>',
  function() require('ui.terminal').toggle { pos = 'vsp', id = 'vtoggleTerm' } end,
  { desc = 'Toggle [v]ertical terminal' }
)
vim.keymap.set(
  { 'n', 't' },
  '<A-h>',
  function() require('ui.terminal').toggle { pos = 'sp', id = 'htoggleTerm' } end,
  { desc = 'Toggle [h]orizontal terminal' }
)
vim.keymap.set(
  { 'n', 't' },
  '<A-i>',
  function() require('ui.terminal').toggle { pos = 'float', id = 'floatTerm' } end,
