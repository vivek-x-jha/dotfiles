...
require('nvim-web-devicons').setup {
  override = {
    ...
    ['.bashrc'] = { icon = icons.gear, name = '.bashrc', color = palette.magenta },
    ['.bash_profile'] = { icon = icons.gear, name = '.bash_profile', color = palette.magenta },
    ['.blerc'] = { icon = icons.gear, name = 'Blerc' },
    ['.zshenv'] = { icon = icons.gear, name = '.zshenv' },
    ['.zshrc'] = { icon = icons.gear, name = '.zshrc', color = palette.magenta },
    ['.zprofile'] = { icon = icons.gear, name = '.zprofile', color = palette.magenta },
    ...
    ['tmux.conf'] = { icon = '', name = 'tmux.conf', color = palette.magenta },
