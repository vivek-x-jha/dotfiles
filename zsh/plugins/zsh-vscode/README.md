...
This plugin provides useful aliases to simplify the interaction between the command line and VS Code or VSCodium editor. Forked from the [oh-my-zsh VS Code plugin](https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/vscode).

## Setup

### [plug](https://github.com/update-this-later)

`vscode` can be activated by calling it with `plug`. To keep activated after the current session, add the following to your zshrc file:
...
`vscode` comes bundled with oh-my-zsh! To use, add it to the plugins array in your zshrc file:
