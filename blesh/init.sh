...
ble-face -s filename_directory 'fg=#80d7fe'
...
ble-face -s varname_array 'fg=#c9ccfb'
ble-face -s varname_empty 'fg=#c9ccfb'
ble-face -s varname_export 'fg=#c9ccfb'
ble-face -s varname_expr 'fg=#c9ccfb'
ble-face -s varname_hash 'fg=#c9ccfb'
ble-face -s varname_number 'fg=#c9ccfb'
ble-face -s varname_readonly 'fg=#c9ccfb'
ble-face -s varname_transform 'fg=#c9ccfb'
